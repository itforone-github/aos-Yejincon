package co.kr.itforone.yejincon;
...
import co.kr.itforone.yejincon.databinding.ActivityWebBinding;
...
//        setting.setAppCacheEnabled(true);//캐쉬 사용여부
        ...
        setting.setUserAgentString("Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Mobile Safari/537.36"+"/YejinSub");
        binding.webView.addJavascriptInterface(new WebActivity.WebJavascriptEvent(), "Android");
        ...
        chrome = new WebChromeClient() {
            ...
            public boolean onShowFileChooser(
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {// API 24 이상 일경우..
                    File imageStorageDir = new File(WebActivity.this.getFilesDir() + "/Pictures", "main_image");
    ...
    WebViewClient client;
    {
        client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                }else if(0 < url.indexOf("item.php")){
